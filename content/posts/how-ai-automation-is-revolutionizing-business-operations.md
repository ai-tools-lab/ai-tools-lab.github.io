...
[params.cover]
  image = "/images/posts/how-ai-automation-is-revolutionizing-business-operations.png"
  alt = "How AI Automation is Revolutionizing Business Operations"
  caption = ""
  relative = false
---
...
```mermaid
graph TD;
    A[Identify Tasks for Automation] --> B[Select AI Tools]
